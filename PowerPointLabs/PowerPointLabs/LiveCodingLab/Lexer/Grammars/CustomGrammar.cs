...
{
    public class CustomGrammar : IGrammar
    {
        ...
        public CustomGrammar(string name, List<LexicalRule> rules, Dictionary<TokenType, Color> colorDict)
        {
            Name = name;
            Rules = rules;
            ColorDict = colorDict;
        ...
        public List<LexicalRule> Rules { get; }
